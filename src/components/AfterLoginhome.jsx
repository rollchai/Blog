        ...
        <div className="row g-4 pt-5 align-itmes">
            ...
            <div className="card-box shadow p-3 ">
              ...
              <div>
                <h3 className="mt-3">
                  ...
                  environments , each aspect contributes to our overall health.
                  Delving into these relationships can pave the way for enhanced
                  vitality.
                </h3>
              </div>
            </div>
          ...
          <div className="col-md-4">
            <div className="shadow p-3">
              ...
              <div>
                <h3 className="mt-3">
                  In the colorful realm of well-being, various factors influence
                  our physical and mental health. From the meals we enjoy to the
                  spaces we occupy, every detail plays a role in our overall
                  wellness. Exploring these connections can lead to greater
                  energy and health.
                </h3>
              </div>
            </div>
          ...
          <div className="col-md-4 ">
            <div className="shadow p-3">
              ...
              <div>
                <h3 className="mt-3">
                  In the lively landscape of health, numerous elements affect
                  our physical and mental well-being. The nutrition we choose
                  and the environments we live in both significantly impact our
                  health. Investigating these links can unlock pathways to
                  improved vitality.
                </h3>
              </div>
            </div>
          ...
          <div className="col-md-4 ">
            <div className="shadow p-3">
              ...
              <div>
                <h3 className="mt-3">
                  In the lively world of wellness, various aspects influence
                  mental and physical health. From the meals we consume to the
                  spaces each factor contributes to our overall well-being.
                  Exploring these connections can lead to improved vitality.
                </h3>
              </div>
            </div>
          </div>
          <div className="col-md-4 ">
            <div className=" shadow p-3">
              ...
              <div>
                <h3 className="mt-3">
                  In the colorful landscape of wellness, numerous elements shape
                  our mental and physical states. The environments we engage
                  with both significantly affect our health. Delving into these
                  relationships can pave the way for greater vitality.
                </h3>
              </div>
            </div>
          </div>
          <div className="col-md-4 ">
            <div className="shadow p-3">
              ...
              <div>
                <h3 className="mt-3">
                  In the vibrant sphere of health, countless factors influence
                  our mental and physical well-being. From the foods we enjoy to
                  the places we inhabit, each aspect plays a role in health.
                  Exploring these connections can lead to enhanced vitality.
                </h3>
              </div>
            </div>
          </div>
          ...
          <div className="col-md-4">
            <div className="shadow p-3">
              ...
              <div>
                <h3 className="mt-3">
                  Within the dynamic sphere of wellness, many factors shape our
                  dynamic mental and physical conditions. The diets we follow
                  and the places we call home are just a few components that
                  influence our health. Understanding these can enhance our
                  overall vitality.
                </h3>
              </div>
            </div>
          ...
          <div className="col-md-4 ">
            <div className="shadow p-3">
              ...
              <div>
                <h3 className="mt-3">
                  In the energetic and colorful world of health, countless
                  factors mold our mental and physical states. From the dishes
                  we savor to the surroundings we dwell in, each detail
                  contributes to our wellness. Examining these connections can
                  lead to a boost in vitality.
                </h3>
              </div>
            </div>
          </div>
          <div className="col-md-4  ">
            <div className="shadow p-3">
              ...
              <div>
                <h3 className="mt-3">
                  In the vibrant domain of wellness, elements impacts our mental
                  and physical health. The foods we eat and the environments we
                  choose to live in play crucial roles in our overall
                  well-being. Investigating these relationships can foster
                  enhanced vitality.
                </h3>
              </div>
            </div>
